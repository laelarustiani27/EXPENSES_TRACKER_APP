...
class _AddIncomeScreenState extends State<AddIncomeScreen> {
      ...
      builder: (context, child) {
        return Theme(
          data: ThemeData.dark().copyWith(
            ...
            canvasColor: Color(0xFF0A2A0A),
            dialogTheme: DialogThemeData(backgroundColor: Color(0xFF0A2A0A)),
          ),
          child: child!,
        );
      },
      ...
      builder: (context) => Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF0A2A0A), Color(0xFF051A05)],
          ),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (args is Income) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Pemasukan berhasil diperbarui'),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Pemasukan berhasil ditambahkan'),
            backgroundColor: Color(0xFF4CAF50),
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(12),
  ...
  String _getCategoryText(IncomeCategory category) {
    switch (category) {
  ...
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)?.settings.arguments;
    final isEditing = args is Income;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    Color.fromRGBO(31, 90, 31, 0.4),
                    Color.fromRGBO(20, 61, 20, 0.3),
                    Colors.transparent,
                  ],
                ),
              ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: RadialGradient(
                  colors: [
                    Color.fromRGBO(31, 90, 31, 0.3),
                    Color.fromRGBO(20, 61, 20, 0.2),
                    Colors.transparent,
                  ],
                ),
              ),
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Color.fromRGBO(26, 61, 26, 0.5),
                          Color.fromRGBO(10, 42, 10, 0.7),
                        ],
                      ),
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: Color.fromRGBO(36, 90, 36, 0.3),
                        width: 1,
                      ),
                      boxShadow: [
                        BoxShadow(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [
                                    Color.fromRGBO(26, 61, 26, 0.4),
                                    Color.fromRGBO(10, 42, 10, 0.6),
                                  ],
                                ),
                                borderRadius: BorderRadius.circular(20),
                                border: Border.all(
  ...
  Widget _build3DInputField({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: Color(0xFF245A24).withValues(alpha: 0.3),
          width: 1,
        ),
        boxShadow: [
          BoxShadow(
          ...
          Row(
            children: [
              Container(
                ...
                child: Icon(icon, color: Color(0xFF9BDB9B), size: 20),
              ),
              const SizedBox(width: 12),
              Text(
                label,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              Color(0xFF1A3D1A).withValues(alpha: 0.4),
              Color(0xFF0A2A0A).withValues(alpha: 0.6),
            ],
          ),
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, color: Color(0xFF9BDB9B), size: 24),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: Column(
